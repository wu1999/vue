...
(function () {
    let $vue = new Vue({
        ...
        data: {
            ...
            boxs: {
                box1: {show: true, hook: '.box1-hook', lock: true, url: '/back/report/dayList/page', params: {}},
        ...
        mounted: function () {
            this.$nextTick(() => {
                ...
                $accountBox.find('input[name=reportTime]').datetimepicker({
                    width: '320px',
                    format: 'Y-m-d',
                    formatDate: 'Y-m-d',
                    scrollMonth: false,
                ...
                var $tableHook = $accountBox.find(tableHookName).bootstrapTable({
                    ...
                    customQueryParams: function (params) {
                        ...
                        var queryParams = $.extend({wareCode:wareCode,itemMasterId:itemMasterId,reportType: 1}, params, formParams);
                        return queryParams;
                    },
