...
(function () {
    let $vue = new Vue({
        ...
        data: {
            ...
            rowData:{},
            boxs: {
                box1: {show: true, hook: '.box1-hook', lock: true, url: '/back/area/page', params: {}},
        ...
        methods: {
            ...
            // 新增
            newArea: function () {
                M.Page.emit(URI.BASE.AREA.AREA_ADD.PAGE);
            },
            ...
            insertArea:function(){
                ...
                IOT.showOverlay('保存中，请稍等...');
                IOT.getServerData(URI.BASE.AREA.AREA_ADD.SAVE,item,(ret) => {
        ...
        mounted: function () {
            this.$nextTick(() => {
                var $accountBox = $('.area-hook');
            
                let tableHookName = '.table-hook';
                // 查询
                ...
                var $tableHook = $accountBox.find(tableHookName).bootstrapTable({
                    ...
                    columns: [
                        ...
                        {
                            field: 'areaCode', title: '货区编码', align: 'center', fixedLeft: true, tips:true
                        },
                        {
                            field: 'areaName', title: '货区名字', align: 'center', fixedLeft: true, tips:true
                        },

                        {
                            field: 'wareName', title: '所属仓库', align: 'center', fixedLeft: true,
                        },
                        {
...

                        {
                            ...
                            events: {
                                ...
                                'click .delete': function (e, value, rowData, index) {
                                    ...
                                    layer.confirm(' &nbsp;&nbsp; &nbsp;&nbsp;是否确认删除此货区？', {
                                        btn: ['确定','取消']
                                    }, function(){
                                        IOT.showOverlay('保存中，请稍等...');
                                        var areaCode = rowData.areaCode;
                                        IOT.getServerData(URI.BASE.AREA.DELETE,{areaCode:areaCode},(ret) => {
                                            IOT.hideOverlay();
                                            if (ret.code === 200) {
                                                IOT.tips('保存成功！', 'success', 1000 , function () {
                                                    layer.closeAll();
